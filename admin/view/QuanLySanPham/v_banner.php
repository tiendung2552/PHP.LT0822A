...
<head>
    ...
    <link rel="stylesheet" href="asset/css/Sanpham/banner.css">
                ...
                <div class="background-right-table">
                    ...
                    <div class="background-right-table-small">  
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        <td><?php echo $value['id_banner']?></td>
                                        <td><img src="../images/slider/<?php echo $value['img_banner']?>" width="250px" height="150px"></td>
                                        <td><?php echo $value['name_banner'] ?></td>
                                        <td class="btn">
                                            <a href="?page=upd_banner&id=<?php echo $value['id_banner'] ?>"><i class="fa-solid fa-gear"></i></a>
                                        </td>
                                    </tr>
                                </tbody>
                              <?php } ?>
